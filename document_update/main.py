...
if __name__ == "__main__":
    ...
    try:
        os.mkdir(temp_dir_dict['temp_dir'])
        os.mkdir(temp_dir_dict['cfs_dir'])
        os.mkdir(temp_dir_dict['aip_dir'])
        os.mkdir(temp_dir_dict['aa_dir'])
        os.mkdir(temp_dir_dict['aim_dir'])
